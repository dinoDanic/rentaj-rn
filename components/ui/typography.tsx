...
const H2 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      ...
      aria-level="2"
      className={cn(
        "border-b border-border pb-2 font-semibold text-3xl tracking-tight text-foreground first:mt-0 web:select-text web:scroll-m-20",
        className
      )}
      ref={ref}
      {...props}
...
const H3 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      role="heading"
      aria-level="3"
      className={cn("font-semibold text-2xl tracking-tight text-foreground web:select-text web:scroll-m-20", className)}
      ref={ref}
      {...props}
    />
  )
...
const H4 = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      role="heading"
      aria-level="4"
      className={cn("font-semibold text-xl tracking-tight text-foreground web:select-text web:scroll-m-20", className)}
      ref={ref}
      {...props}
    />
  )
...
const Code = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      ...
      className={cn(
        "relative rounded-md bg-muted px-[0.3rem] py-[0.2rem] font-semibold text-sm text-foreground web:select-text",
        className
      )}
      ref={ref}
      {...props}
...
const Large = React.forwardRef<TextRef, SlottableTextProps>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Component
      className={cn("font-semibold text-xl text-foreground web:select-text", className)}
      ref={ref}
      {...props}
    />
  )
